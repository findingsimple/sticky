...
function theme_meta_box() {
	...
	<tr>
		<th>
			<label for="<?php echo hybrid_settings_field_id( 'banner-headline' ); ?>"><?php _e('Front Page Banner Headline:',hybrid_get_parent_textdomain()); ?></label>
		</th>
		<td>
	...
	<tr>
		<th>
			<label for="<?php echo hybrid_settings_field_id( 'banner-subtext' ); ?>"><?php _e('Front Page Banner Subtext:',hybrid_get_parent_textdomain()); ?></label>
		</th>
		<td>
